...
export const ThemeToggle = ({ theme, toggleTheme }:{ theme: string; toggleTheme: () => void; }) => {
  return (
    <motion.button onClick={toggleTheme} whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="relative p-3 rounded-xl overflow-hidden transition-colors duration-300" >
      <motion.div
