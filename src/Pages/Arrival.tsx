...
export default function Arrival(): JSX.Element {
  return (
    <section className="flex flex-col items-center justify-center text-center gap-6 md:gap-11 mt-20 px-4">
      ...
      <p className="lg:text-3xl md:text-xl md:w-1/2">TaskFlow combines functionality with intuitive design to help you manage tasks, track progress, and collaborate seamlessly with your team.</p>
